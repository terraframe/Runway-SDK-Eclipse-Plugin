...
/**
 * This is the item provider adapter for a {@link com.runwaysdk.eclipse.plugin.runway.MetaData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MetaData_label_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_MetaData_label_feature", "_UI_MetaData_type"),
         RunwayPackage.Literals.META_DATA__LABEL,
         true,
         false,
         false,
  ...
  protected void addDescriptionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MetaData_description_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_MetaData_description_feature", "_UI_MetaData_type"),
         RunwayPackage.Literals.META_DATA__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addRemovablePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MetaData_removable_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_MetaData_removable_feature", "_UI_MetaData_type"),
         RunwayPackage.Literals.META_DATA__REMOVABLE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  {
    String label = ((MetaData)object).getLabel();
