...
public class RunwayFactoryImpl extends EFactoryImpl implements RunwayFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RunwayPackage.META_DATA: return createMetaData();
			case RunwayPackage.MD_TYPE: return createMDType();
			case RunwayPackage.MD_CLASS: return createMDClass();
			case RunwayPackage.MD_ENTITY: return createMDEntity();
			case RunwayPackage.MD_ELEMENT: return createMDElement();
	...
	public MDType createMDType() {
		MDTypeImpl mdType = new MDTypeImpl();
		return mdType;
	}
	 ...
	 * @generated
	 */
	public MDClass createMDClass() {
		MDClassImpl mdClass = new MDClassImpl();
		return mdClass;
	}
	 ...
	 * @generated
	 */
	public MDEntity createMDEntity() {
		MDEntityImpl mdEntity = new MDEntityImpl();
		return mdEntity;
	}
	 ...
	 * @generated
	 */
	public MDElement createMDElement() {
		MDElementImpl mdElement = new MDElementImpl();
		return mdElement;
	}
