 ...
 * @generated
 */
public class MdAttributeNumberNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeNumberNameEditPart(View view)
  {
    super(view);
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeNumber_3011, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeNumberNameEditPart.VISUAL_ID));
    }
    return parser;
  }
