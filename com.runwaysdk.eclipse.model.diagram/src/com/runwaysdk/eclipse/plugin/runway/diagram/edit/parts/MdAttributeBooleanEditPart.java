...
import com.runwaysdk.eclipse.plugin.runway.diagram.edit.policies.MdAttributeBooleanItemSemanticEditPolicy;
...
public class MdAttributeBooleanEditPart extends ShapeNodeEditPart
{
  ...
  protected boolean addFixedChild(EditPart childEditPart)
  {
    ...
    {
      ( (MdAttributeBooleanNameEditPart) childEditPart ).setLabel(getPrimaryShape().getFigureMdAttributeBooleanNameFigure());
      return true;
    }
    return false;
  }
  ...
  {
    return getChildBySemanticHint(RunwayVisualIDRegistry.getType(MdAttributeBooleanNameEditPart.VISUAL_ID));
  }
