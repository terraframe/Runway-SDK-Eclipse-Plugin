 ...
 * @generated
 */
public class MdAttributeTextNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeTextNameEditPart(View view)
  {
    super(view);
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeText_3004, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeTextNameEditPart.VISUAL_ID));
    }
    return parser;
  }
