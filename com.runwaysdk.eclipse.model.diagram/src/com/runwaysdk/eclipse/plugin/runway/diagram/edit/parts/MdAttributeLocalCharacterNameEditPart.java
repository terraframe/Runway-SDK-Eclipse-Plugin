...
import com.runwaysdk.eclipse.plugin.runway.diagram.edit.policies.RunwayTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MdAttributeLocalCharacterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeLocalCharacterNameEditPart(View view)
  {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies()
  {
    ...
    installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new RunwayTextSelectionEditPolicy());
    installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new LabelDirectEditPolicy());
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new DocumentRootEditPart.NodeLabelDragPolicy());
  }
  ...
  protected Image getLabelIcon()
  {
    ...
    return RunwayElementTypes.getImage(parserElement.eClass());
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeLocalCharacter_3006, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeLocalCharacterNameEditPart.VISUAL_ID));
    }
    return parser;
  }
  ...
  protected DirectEditManager getManager()
  {
    if (manager == null)
    {
      setManager(new TextDirectEditManager2(this, null, RunwayEditPartFactory.getTextCellEditorLocator(this)));
    }
    return manager;
  }
