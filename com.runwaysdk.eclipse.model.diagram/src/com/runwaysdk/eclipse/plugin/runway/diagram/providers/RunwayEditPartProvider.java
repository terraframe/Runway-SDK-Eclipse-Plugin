...
import com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.RunwayEditPartFactory;
import com.runwaysdk.eclipse.plugin.runway.diagram.part.RunwayVisualIDRegistry;

/**
 * @generated
 */
public class RunwayEditPartProvider extends AbstractEditPartProvider
{
   ...
   * @generated
   */
  public RunwayEditPartProvider()
  {
    setFactory(new RunwayEditPartFactory());
  ...
  public synchronized boolean provides(IOperation operation)
  {
    if (operation instanceof CreateGraphicEditPartOperation)
    {
      ...
      if (!DocumentRootEditPart.MODEL_ID.equals(RunwayVisualIDRegistry.getModelID(view)))
      {
        return false;
      }
