  ...
  static
  {
    ...
    Platform.getAdapterManager().registerAdapters(new IAdapterFactory()
    {
      ...
      public Object getAdapter(Object adaptableObject, Class adapterType)
      {
        ...
        {
          return ( (com.runwaysdk.eclipse.plugin.runway.diagram.navigator.RunwayNavigatorItem) adaptableObject ).getView();
        }
        return null;
      }
  ...
  public boolean equals(Object obj)
  {
    if (obj instanceof com.runwaysdk.eclipse.plugin.runway.diagram.navigator.RunwayNavigatorItem)
    {
      return EcoreUtil.getURI(getView()).equals(
          EcoreUtil.getURI( ( (com.runwaysdk.eclipse.plugin.runway.diagram.navigator.RunwayNavigatorItem) obj ).getView()));
    }
