...
public class RunwayPaletteFactory {
	...
	private PaletteContainer createAttributes2Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				Messages.Attributes2Group_title);
	...
	private ToolEntry createRunwayClass1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.RunwayClass1CreationTool_title,
		...
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDBusiness_2003));
	...
	private ToolEntry createBlob1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Blob1CreationTool_title,
				Messages.Blob1CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeBlob_3038));
		entry.setId("createBlob1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeBlob_3038));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createBoolean2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Boolean2CreationTool_title,
				Messages.Boolean2CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeBoolean_3044));
		entry.setId("createBoolean2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeBoolean_3044));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCharacter3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Character3CreationTool_title,
				Messages.Character3CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeCharacter_3049));
	...
	private ToolEntry createDate4CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(RunwayElementTypes.MDAttributeDate_3037));
		entry.setId("createDate4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeDate_3037));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDateTime5CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.DateTime5CreationTool_title,
				Messages.DateTime5CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeDateTime_3046));
	...
	private ToolEntry createDecimal6CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Decimal6CreationTool_title,
				Messages.Decimal6CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeDecimal_3041));
		entry.setId("createDecimal6CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeDecimal_3041));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDouble7CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Double7CreationTool_title,
				Messages.Double7CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeDouble_3040));
		entry.setId("createDouble7CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeDouble_3040));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createEnumeration8CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(RunwayElementTypes.MDAttributeEnumeration_3051));
	...
	private ToolEntry createFloat9CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Float9CreationTool_title,
				Messages.Float9CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeFloat_3050));
		entry.setId("createFloat9CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeFloat_3050));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createHash10CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Hash10CreationTool_title,
				Messages.Hash10CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeHash_3052));
		entry.setId("createHash10CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeHash_3052));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createInteger11CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Integer11CreationTool_title,
				Messages.Integer11CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeInteger_3047));
		entry.setId("createInteger11CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeInteger_3047));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNumber12CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Number12CreationTool_title,
				Messages.Number12CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeNumber_3045));
		entry.setId("createNumber12CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeNumber_3045));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createText14CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Text14CreationTool_title,
				Messages.Text14CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeText_3036));
		entry.setId("createText14CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeText_3036));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createTime15CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Time15CreationTool_title,
				Messages.Time15CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeTime_3043));
		entry.setId("createTime15CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeTime_3043));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCharacter16CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Character16CreationTool_title,
				Messages.Character16CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeLocalCharacter_3039));
	...
	private ToolEntry createText17CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Text17CreationTool_title,
				Messages.Text17CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeLocalText_3048));
	...
	private ToolEntry createLong18CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Long18CreationTool_title,
				Messages.Long18CreationTool_desc,
				Collections
						.singletonList(RunwayElementTypes.MDAttributeLong_3042));
		entry.setId("createLong18CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RunwayElementTypes
				.getImageDescriptor(RunwayElementTypes.MDAttributeLong_3042));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
