...
public class DocumentRootCanonicalEditPolicy extends CanonicalEditPolicy
{
  ...
  {
    return RunwayPackage.eINSTANCE.getDocumentRoot_MdBusinesses();
  }
  ...
  protected List getSemanticChildrenList()
  {
    ...
    List<RunwayNodeDescriptor> childDescriptors = RunwayDiagramUpdater.getDocumentRoot_1000SemanticChildren(viewObject);
  ...
  {
    return MDBusinessEditPart.VISUAL_ID == RunwayVisualIDRegistry.getVisualID(view);
  }
  ...
  protected void refreshSemantic()
  {
    ...
    List<RunwayNodeDescriptor> childDescriptors = RunwayDiagramUpdater.getDocumentRoot_1000SemanticChildren((View) getHost().getModel());
