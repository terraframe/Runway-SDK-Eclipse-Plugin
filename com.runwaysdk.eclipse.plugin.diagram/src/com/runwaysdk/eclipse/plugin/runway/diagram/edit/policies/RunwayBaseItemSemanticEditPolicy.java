 ...
 * @generated
 */
public class RunwayBaseItemSemanticEditPolicy extends SemanticEditPolicy
{
   ...
   * @generated
   */
  protected RunwayBaseItemSemanticEditPolicy(IElementType elementType)
  {
  ...
  public Command getCommand(Request request)
  {
    if (request instanceof ReconnectRequest)
    {
      ...
      {
        Integer id = new Integer(RunwayVisualIDRegistry.getVisualID((View) view));
  ...
  {
    IElementType requestContextElementType = RunwayElementTypes.getElementType(getVisualID(request));
