...
public class RunwayNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case DocumentRootEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RunwayVisualIDRegistry
							.getType(MDBusinessEditPart.VISUAL_ID));
		...
		case MDBusinessEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeTextEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeDateEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeBlobEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(
					connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeLocalCharacterEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeDoubleEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeDecimalEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeLongEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeTimeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeBooleanEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeNumberEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeDateTimeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeIntegerEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeLocalTextEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeCharacterEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeFloatEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeEnumerationEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RunwayVisualIDRegistry
							.getType(MDAttributeHashEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
	 ...
	 * @generated
	 */
	private Collection<RunwayNavigatorItem> createNavigatorItems(
