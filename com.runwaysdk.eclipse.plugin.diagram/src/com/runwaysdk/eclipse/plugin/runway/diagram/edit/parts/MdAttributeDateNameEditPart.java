 ...
 * @generated
 */
public class MdAttributeDateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeDateNameEditPart(View view)
  {
    super(view);
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeDate_3005, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeDateNameEditPart.VISUAL_ID));
    }
    return parser;
  }
