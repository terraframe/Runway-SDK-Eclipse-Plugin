    ...
    ITreePathLabelProvider
{
  ...
  public Image getImage(View view)
  {
    switch (RunwayVisualIDRegistry.getVisualID(view))
    {
      ...
      case MDBusinessEditPart.VISUAL_ID:
        return getImage("Navigator?TopLevelNode?runway?MDBusiness", RunwayElementTypes.MDBusiness_2003); //$NON-NLS-1$
      case MDAttributeTextEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeText", RunwayElementTypes.MDAttributeText_3036); //$NON-NLS-1$
      case MDAttributeDateEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeDate", RunwayElementTypes.MDAttributeDate_3037); //$NON-NLS-1$
      case MDAttributeBlobEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeBlob", RunwayElementTypes.MDAttributeBlob_3038); //$NON-NLS-1$
      ...
      case MDAttributeLongEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeLong", RunwayElementTypes.MDAttributeLong_3042); //$NON-NLS-1$
      case MDAttributeTimeEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeTime", RunwayElementTypes.MDAttributeTime_3043); //$NON-NLS-1$
      ...
      case MDAttributeHashEditPart.VISUAL_ID:
        return getImage("Navigator?Node?runway?MDAttributeHash", RunwayElementTypes.MDAttributeHash_3052); //$NON-NLS-1$
    }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDBusiness_2003,
        view.getElement() != null ? view.getElement() : view,
        RunwayVisualIDRegistry.getType(MDBusinessNameEditPart.VISUAL_ID));
    if (parser != null)
    {
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5055); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeText_3036,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5038); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeDate_3037,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5039); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeBlob_3038,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5040); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeLocalCharacter_3039,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5041); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeDouble_3040,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5042); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeDecimal_3041,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5043); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeLong_3042,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5044); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeTime_3043,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5045); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeBoolean_3044,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5046); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeNumber_3045,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5047); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeDateTime_3046,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5048); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeInteger_3047,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5049); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeLocalText_3048,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5050); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeCharacter_3049,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5051); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeFloat_3050,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5052); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeEnumeration_3051,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5053); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IParser parser = RunwayParserProvider.getParser(RunwayElementTypes.MDAttributeHash_3052,
        view.getElement() != null ? view.getElement() : view,
    ...
    {
      RunwayDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5054); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
