...
public class MDBusinessEditPart extends ShapeNodeEditPart
{
  ...
  protected boolean addFixedChild(EditPart childEditPart)
  {
    ...
    {
      ( (MDBusinessClassNameEditPart) childEditPart ).setLabel(getPrimaryShape()
  ...
  public EditPart getTargetEditPart(Request request)
  {
    if (request instanceof CreateViewAndElementRequest)
    {
      ...
      if (type == RunwayElementTypes.MDAttributeText_3019)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeDate_3020)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeBlob_3021)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeLocalCharacter_3022)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeDouble_3023)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeDecimal_3024)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeLong_3025)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeTime_3026)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeBoolean_3027)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeNumber_3028)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeDateTime_3029)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeInteger_3030)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeLocalText_3031)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeCharacter_3032)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeFloat_3033)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeEnumeration_3034)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
      if (type == RunwayElementTypes.MDAttributeHash_3035)
      {
        return getChildBySemanticHint(RunwayVisualIDRegistry
            .getType(MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID));
      }
