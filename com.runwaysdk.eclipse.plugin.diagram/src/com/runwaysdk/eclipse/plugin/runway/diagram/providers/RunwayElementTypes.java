	...
	private static ImageDescriptor getProvidedImageDescriptor(
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return RunwayDiagramEditorPlugin.getInstance()
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(DocumentRoot_1000,
					RunwayPackage.eINSTANCE.getDocumentRoot());

			elements.put(MDBusiness_2003,
					RunwayPackage.eINSTANCE.getMDBusiness());

			elements.put(MDAttributeText_3036,
					RunwayPackage.eINSTANCE.getMDAttributeText());

			elements.put(MDAttributeDate_3037,
					RunwayPackage.eINSTANCE.getMDAttributeDate());

			elements.put(MDAttributeBlob_3038,
					RunwayPackage.eINSTANCE.getMDAttributeBlob());

			elements.put(MDAttributeLocalCharacter_3039,
					RunwayPackage.eINSTANCE.getMDAttributeLocalCharacter());

			elements.put(MDAttributeDouble_3040,
					RunwayPackage.eINSTANCE.getMDAttributeDouble());

			elements.put(MDAttributeDecimal_3041,
					RunwayPackage.eINSTANCE.getMDAttributeDecimal());

			elements.put(MDAttributeLong_3042,
					RunwayPackage.eINSTANCE.getMDAttributeLong());

			elements.put(MDAttributeTime_3043,
					RunwayPackage.eINSTANCE.getMDAttributeTime());

			elements.put(MDAttributeBoolean_3044,
					RunwayPackage.eINSTANCE.getMDAttributeBoolean());

			elements.put(MDAttributeNumber_3045,
					RunwayPackage.eINSTANCE.getMDAttributeNumber());

			elements.put(MDAttributeDateTime_3046,
					RunwayPackage.eINSTANCE.getMDAttributeDateTime());

			elements.put(MDAttributeInteger_3047,
					RunwayPackage.eINSTANCE.getMDAttributeInteger());

			elements.put(MDAttributeLocalText_3048,
					RunwayPackage.eINSTANCE.getMDAttributeLocalText());

			elements.put(MDAttributeCharacter_3049,
					RunwayPackage.eINSTANCE.getMDAttributeCharacter());

			elements.put(MDAttributeFloat_3050,
					RunwayPackage.eINSTANCE.getMDAttributeFloat());

			elements.put(MDAttributeEnumeration_3051,
					RunwayPackage.eINSTANCE.getMDAttributeEnumeration());

			elements.put(MDAttributeHash_3052,
					RunwayPackage.eINSTANCE.getMDAttributeHash());
		}
