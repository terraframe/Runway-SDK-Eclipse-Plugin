...
public class ModelElementSelectionPage extends WizardPage
{
  ...
  public void createControl(Composite parent)
  {
    ...
    modelViewer.setContentProvider(new AdapterFactoryContentProvider(RunwayDiagramEditorPlugin
        .getInstance().getItemProvidersAdapterFactory()));
    modelViewer.setLabelProvider(new AdapterFactoryLabelProvider(RunwayDiagramEditorPlugin.getInstance()
