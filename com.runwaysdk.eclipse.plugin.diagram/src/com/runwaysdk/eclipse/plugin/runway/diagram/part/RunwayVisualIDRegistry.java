...
public class RunwayVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (RunwayPackage.eINSTANCE.getDocumentRoot().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case DocumentRootEditPart.VISUAL_ID:
			if (RunwayPackage.eINSTANCE.getMDBusiness().isSuperTypeOf(
					domainElement.eClass())) {
				return MDBusinessEditPart.VISUAL_ID;
			}
			break;
		case MDBusinessMdBusinessCompartmentEditPart.VISUAL_ID:
			if (RunwayPackage.eINSTANCE.getMDAttributeText().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeTextEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeDate().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeDateEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeBlob().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeBlobEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeLocalCharacter()
					.isSuperTypeOf(domainElement.eClass())) {
				return MDAttributeLocalCharacterEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeDouble().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeDoubleEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeDecimal().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeDecimalEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeLong().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeLongEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeTime().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeTimeEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeBoolean().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeBooleanEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeNumber().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeNumberEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeDateTime().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeDateTimeEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeInteger().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeIntegerEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeLocalText()
					.isSuperTypeOf(domainElement.eClass())) {
				return MDAttributeLocalTextEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeCharacter()
					.isSuperTypeOf(domainElement.eClass())) {
				return MDAttributeCharacterEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeFloat().isSuperTypeOf(
					domainElement.eClass())) {
				return MDAttributeFloatEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeEnumeration()
					.isSuperTypeOf(domainElement.eClass())) {
				return MDAttributeEnumerationEditPart.VISUAL_ID;
			}
			if (RunwayPackage.eINSTANCE.getMDAttributeHash().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case MDBusinessEditPart.VISUAL_ID:
			if (MDBusinessNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
