 ...
 * @generated
 */
public class MDBusinessMdBusinessCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RunwayPackage.eINSTANCE.getMDClass_Attributes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<RunwayNodeDescriptor> childDescriptors = RunwayDiagramUpdater
				.getMDBusinessMdBusinessCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<RunwayNodeDescriptor> childDescriptors = RunwayDiagramUpdater
				.getMDBusinessMdBusinessCompartment_7003SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator<RunwayNodeDescriptor> descriptorsIterator = childDescriptors
