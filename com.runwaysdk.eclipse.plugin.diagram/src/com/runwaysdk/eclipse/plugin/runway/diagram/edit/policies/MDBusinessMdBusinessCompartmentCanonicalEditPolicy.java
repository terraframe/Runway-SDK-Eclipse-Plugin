...
public class MDBusinessMdBusinessCompartmentCanonicalEditPolicy extends CanonicalEditPolicy
{
  ...
  protected void refreshSemantic()
  {
    ...
    List<RunwayNodeDescriptor> childDescriptors = RunwayDiagramUpdater
        .getMDBusinessMdBusinessCompartment_7003SemanticChildren((View) getHost().getModel());
    ...
    for (Iterator<RunwayNodeDescriptor> descriptorsIterator = childDescriptors.iterator(); descriptorsIterator
        .hasNext();)
    {
