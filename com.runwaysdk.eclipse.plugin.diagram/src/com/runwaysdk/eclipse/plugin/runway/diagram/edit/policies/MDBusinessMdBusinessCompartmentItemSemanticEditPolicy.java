    ...
    RunwayBaseItemSemanticEditPolicy
{
  ...
  protected Command getCreateCommand(CreateElementRequest req)
  {
    ...
    if (RunwayElementTypes.MDAttributeLocalCharacter_3039 == req.getElementType())
    {
    ...
    if (RunwayElementTypes.MDAttributeLocalText_3048 == req.getElementType())
    {
      return getGEFWrapper(new MDAttributeLocalTextCreateCommand(req));
    }
    if (RunwayElementTypes.MDAttributeCharacter_3049 == req.getElementType())
    {
    ...
    if (RunwayElementTypes.MDAttributeEnumeration_3051 == req.getElementType())
    {
