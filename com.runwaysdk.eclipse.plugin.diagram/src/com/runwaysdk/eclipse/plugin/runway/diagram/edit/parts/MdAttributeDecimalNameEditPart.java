 ...
 * @generated
 */
public class MdAttributeDecimalNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeDecimalNameEditPart(View view)
  {
    super(view);
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeDecimal_3008, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeDecimalNameEditPart.VISUAL_ID));
    }
    return parser;
  }
