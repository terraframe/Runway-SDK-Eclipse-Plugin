 ...
 * @generated
 */
public class MdAttributeBooleanNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public MdAttributeBooleanNameEditPart(View view)
  {
    super(view);
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider.getParser(RunwayElementTypes.MdAttributeBoolean_3003, getParserElement(),
          RunwayVisualIDRegistry.getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MdAttributeBooleanNameEditPart.VISUAL_ID));
    }
    return parser;
  }
