 ...
 * @generated
 */
public class MDAttributeLocalCharacterNameEditPart extends CompartmentEditPart implements
    ITextAwareEditPart
{
  ...
  protected String getLabelText()
  {
    ...
    {
      text = getParser()
          .getPrintString(new EObjectAdapter(parserElement), getParserOptions().intValue());
    }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = RunwayParserProvider
          .getParser(
              RunwayElementTypes.MDAttributeLocalCharacter_3022,
              getParserElement(),
              RunwayVisualIDRegistry
                  .getType(com.runwaysdk.eclipse.plugin.runway.diagram.edit.parts.MDAttributeLocalCharacterNameEditPart.VISUAL_ID));
    }
    return parser;
  }
  ...
  protected DirectEditManager getManager()
  {
    if (manager == null)
    {
      setManager(new TextDirectEditManager2(this, null,
          RunwayEditPartFactory.getTextCellEditorLocator(this)));
    }
    return manager;
  }
