...
public abstract class MdAttributeParser extends MdMetaDataParser
{
  ...
  public MDAttribute parse()
  {
    ...
    {
      mdAttribute.setRequired(Boolean.parseBoolean(nodeMap.getNamedItem(XMLTags.REQUIRED_ATTRIBUTE)
          .getNodeValue()));
    ...
    {
      mdAttribute.setImmutable(Boolean.parseBoolean(nodeMap.getNamedItem(XMLTags.IMMUTABLE_ATTRIBUTE)
          .getNodeValue()));
